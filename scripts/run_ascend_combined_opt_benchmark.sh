...
# 1. fp16 softmax (LTX2_ASCEND_SOFTMAX_FP16=1)
# 2. chunk=1024 (LTX2_ASCEND_ATTENTION_CHUNK=1024)
# 5 steps for quick comparison.
...
OUTPUT="${OUTPUT_DIR}/fp16_softmax_chunk1024_512x768_f73_s5_seed10.mp4"
mkdir -p "${OUTPUT_DIR}"
...
echo "Combined optimization benchmark complete: ${OUTPUT}"
