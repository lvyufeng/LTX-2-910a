...
# Uses max-batch-size 2 to reduce transfer overhead without overloading NPU memory.
...
OUTPUT="${OUTPUT_DIR}/batch_guidance_opt_mbs2_512x768_f73_s5_seed10.mp4"
mkdir -p "${OUTPUT_DIR}"
...
echo "Batch guidance mbs2 benchmark complete: ${OUTPUT}"
