#!/bin/bash
# Full 30-step production benchmark with fp16 softmax optimization.
# Compare against baseline ~525s total / ~320s denoise.
...
OUTPUT="${OUTPUT_DIR}/fp16_softmax_512x768_f73_s30_seed10.mp4"
mkdir -p "${OUTPUT_DIR}"
...
echo "Full 30-step fp16 softmax benchmark complete: ${OUTPUT}"
