#!/bin/bash
# Benchmark with fp16 softmax in attention (no fp32 upcast).
# Same precision config as the good run, 5 steps for quick comparison.
# Key change: LTX2_ASCEND_SOFTMAX_FP16=1
...
OUTPUT="${OUTPUT_DIR}/fp16_softmax_512x768_f73_s5_seed10.mp4"
mkdir -p "${OUTPUT_DIR}"
...
echo "fp16 softmax benchmark complete: ${OUTPUT}"
