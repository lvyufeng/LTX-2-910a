#!/bin/bash
# Benchmark experimental batched guidance on NPU.
# Keeps precision-preserving operator optimizations:
# - fp16 attention softmax
# - attention chunk=1024
# Adds:
# - LTX2_NPU_BATCH_GUIDANCE=1
# 5 steps with profiling for quick comparison.
...
OUTPUT="${OUTPUT_DIR}/batch_guidance_opt_512x768_f73_s5_seed10.mp4"
mkdir -p "${OUTPUT_DIR}"
...
export LTX2_NPU_BATCH_GUIDANCE=1
...
echo "Batch guidance benchmark complete: ${OUTPUT}"
