...
class TransformerArgs:
    ...
    def to(self, device: torch.device) -> "TransformerArgs":
        def move(value):
        ...
        return replace(
            ...
            self_attn_perturbation_mask=move(self.self_attn_perturbation_mask),
            cross_attn_perturbation_mask=move(self.cross_attn_perturbation_mask),
        )
