...
from ltx_core.random import GeneratorLike, randn_tensor
...
def _resnet_block_forward_inplace(
    ...
    if resnet.inject_noise:
        ...
        noise = randn_tensor(spatial_shape, device=interior.device, dtype=interior.dtype, generator=generator)
