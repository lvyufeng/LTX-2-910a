...
try:
    ...
    raise RuntimeError("torch_npu must be importable to build the long-K softmax binding") from exc
...
CUSTOM_OP_INCLUDE = ROOT / "ascendc" / "long_k_softmax" / "generated" / "build_out" / "autogen"
...
setup(
    name="ltx2_ascend_ops_long_k_softmax_binding",
    ext_modules=[
        CppExtension(
            name="ltx2_ascend_ops._long_k_softmax_binding",
            sources=[str(ROOT / "csrc" / "long_k_softmax_binding.cpp")],
